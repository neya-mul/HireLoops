        ...
        <div className="w-full bg-[#121212]/90 border border-neutral-800/80 hover:border-neutral-700/60 rounded-2xl p-8 backdrop-blur-xl transition-all duration-300 ease-out hover:scale-[1.01] shadow-[0_0_50px_rgba(0,0,0,0.8)] hover:shadow-[0_0_60px_rgba(88,80,236,0.1)]">
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-sm text-neutral-400">
              Start tracking and landing your dream roles today.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-2.5 mt-1">
              ...
              />
              <label htmlFor="agreeTerms" className="text-xs text-neutral-400 leading-normal select-none cursor-pointer hover:text-neutral-300 transition-colors">
                I agree to the{' '}
                <Link href="#" className="text-[#6366f1] hover:text-[#4f46e5] transition-colors hover:underline">Terms of Service</Link>
                {' '}and{' '}
                <Link href="#" className="text-[#6366f1] hover:text-[#4f46e5] transition-colors hover:underline">Privacy Policy</Link>.
              </label>
            </div>
          ...
          {/* Bottom Login redirect toggle */}
          <div className="text-center mt-8 text-sm text-neutral-500">
            Already have an account?{' '}
            <Link href="/signin" className="text-[#6366f1] font-medium hover:text-[#4f46e5] transition-colors hover:underline">
              Sign In
            </Link>
          </div>
